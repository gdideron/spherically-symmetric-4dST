   ...
   vector<double> &det)
{
   for (int i=exc_i+2; i<nx-3; ++i) {
      ...
      det[i]= 
         (-128*pow(Bep,2)*pow(r_Der_P,2)*pow(N,2)*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2))/pow(r,2) + (pow(r_Der_S,2)*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(256*pow(Bep,2)*pow(N,2)*P*Q*S + 128*pow(Bep,2)*pow(N,2)*pow(P,2)*pow(S,2) - 128*pow(Bep,2)*pow(N,2)*pow(Q + P*S,2)))/pow(r,2) + (pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(-pow(N,2) + 16*Bepp*pow(N,2)*pow(Q,2) + 16*Bepp*N*pow(Q,2)*S - 16*Bepp*pow(N,2)*pow(Q,2)*pow(S,2) - 16*Bepp*pow(N,2)*pow(P + Q*S,2) + 16*Bepp*pow(N,3)*S*pow(P + Q*S,2)))/pow(r,2) + (r_Der_Q*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(8*sqrt(2)*Bep*pow(N,2) - 128*sqrt(2)*Bep*Bepp*N*pow(Q,2)*S + 128*sqrt(2)*Bep*Bepp*pow(N,2)*pow(Q,2)*pow(S,2) + 128*sqrt(2)*Bep*Bepp*pow(N,2)*pow(P + Q*S,2) - 128*sqrt(2)*Bep*Bepp*pow(N,3)*S*pow(P + Q*S,2)))/pow(r,2) + (pow(r_Der_N,2)*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(128*pow(Bep,2)*pow(P,2)*pow(S,4) - 128*pow(Bep,2)*pow(S,2)*pow(Q + P*S,2) + 128*pow(Bep,2)*P*Q*S*(-1 + 2*pow(S,2))))/pow(r,2) + t_Der_P*((128*pow(Bep,2)*r_Der_Q*N*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2))/pow(r,2) + (128*pow(Bep,2)*r_Der_S*N*P*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2))/pow(r,2) + ((-8*sqrt(2)*Bep*N + 128*sqrt(2)*Bep*Bepp*N*pow(Q,2))*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2))/pow(r,2) + (128*pow(Bep,2)*r_Der_N*P*S*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2))/pow(r,2)) + r_Der_P*((-128*pow(Bep,2)*r_Der_Q*pow(N,2)*S*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2))/pow(r,2) + (pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(-128*sqrt(2)*Bep*Bepp*N*pow(Q,2) + 8*sqrt(2)*Bep*pow(N,2)*S + 128*sqrt(2)*Bep*Bepp*pow(N,2)*pow(Q,2)*S - 128*sqrt(2)*Bep*Bepp*pow(N,3)*pow(P + Q*S,2)))/pow(r,2)) + r_Der_S*((r_Der_P*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(128*pow(Bep,2)*pow(N,2)*P*S - 256*pow(Bep,2)*pow(N,2)*(Q + P*S)))/pow(r,2) + (r_Der_Q*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(256*pow(Bep,2)*pow(N,2)*Q*S + 256*pow(Bep,2)*pow(N,2)*P*pow(S,2) - 256*pow(Bep,2)*pow(N,2)*S*(Q + P*S)))/pow(r,2) + (pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(8*sqrt(2)*Bep*pow(N,2)*P - 16*sqrt(2)*Bep*pow(N,2)*Q*S + 256*sqrt(2)*Bep*Bepp*pow(N,2)*pow(Q,3)*S - 16*sqrt(2)*Bep*pow(N,2)*P*pow(S,2) + 128*sqrt(2)*Bep*Bepp*pow(N,2)*P*pow(Q,2)*pow(S,2) - 128*sqrt(2)*Bep*Bepp*N*pow(Q,2)*(Q + P*S) + 16*sqrt(2)*Bep*pow(N,2)*S*(Q + P*S) + 128*sqrt(2)*Bep*Bepp*pow(N,2)*P*pow(P + Q*S,2) - 128*sqrt(2)*Bep*Bepp*pow(N,3)*(Q + P*S)*pow(P + Q*S,2)))/pow(r,2)) + r_Der_N*((r_Der_P*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(128*pow(Bep,2)*N*P*pow(S,2) - 256*pow(Bep,2)*N*S*(Q + P*S)))/pow(r,2) + (r_Der_Q*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(256*pow(Bep,2)*N*P*pow(S,3) - 256*pow(Bep,2)*N*pow(S,2)*(Q + P*S) + 128*pow(Bep,2)*N*Q*(-1 + 2*pow(S,2))))/pow(r,2) + (r_Der_S*pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(256*pow(Bep,2)*N*P*Q*pow(S,2) + 256*pow(Bep,2)*N*pow(P,2)*pow(S,3) - 256*pow(Bep,2)*N*S*pow(Q + P*S,2) + 128*pow(Bep,2)*N*P*Q*(-1 + 2*pow(S,2))))/pow(r,2) + (pow(r - 8*sqrt(2)*Bep*(Q + P*S),2)*(8*sqrt(2)*Bep*N*P*S - 16*sqrt(2)*Bep*N*P*pow(S,3) + 128*sqrt(2)*Bep*Bepp*N*P*pow(Q,2)*pow(S,3) - 128*sqrt(2)*Bep*Bepp*pow(Q,2)*S*(Q + P*S) + 16*sqrt(2)*Bep*N*pow(S,2)*(Q + P*S) + 128*sqrt(2)*Bep*Bepp*N*P*S*pow(P + Q*S,2) - 128*sqrt(2)*Bep*Bepp*pow(N,2)*S*(Q + P*S)*pow(P + Q*S,2) - 8*sqrt(2)*Bep*N*Q*(-1 + 2*pow(S,2)) + 128*sqrt(2)*Bep*Bepp*N*pow(Q,3)*(-1 + 2*pow(S,2))))/pow(r,2))
         ;
   }
   return;
}
