...
sim.data_dir= os.path.join(project_dir,"output",git_hash)
...
if (sim.run_type == 'basic_run'):
   sim.launch()
#=============================================================================
elif (sim.run_type == 'mass_search'):
    experiment_folder = os.path.join(sim.data_dir,"mass_search")
    data_list = os.path.join(experiment_folder,"data_list.txt") 
    try:
    ...
    for mass in [1,2.5,5]:
        sim.bh_mass = mass
        sim.launch()
        sim.write_sim_params(experiment_folder+f'/sim_params_m{mass}.txt')
        with open(data_list,'a') as f:
            f.write(sim.data_folder+"\n")
#=============================================================================
