...
\abstract{We consider spherical black hole dynamics for a class of scalar-tensor
   gravity theories that describe the leading-order derivative expansion from
   General Relativity, $4\partial ST$ gravity.
   }
...
+  2\delta^{efcd}_{ijg(a}g_{b)d}R^{ij}{}_{ef}
   ...
   .
\end{align}
   Details of our numerical methodology can be found in the Appendix.
%=============================================================================
\section{Model: $V=\cdots$, $\alpha=\cdots$, $\beta=\cdots$}
...
solution into the $rr$ component of the tensor equations, $E^{(g)}_{rr}$,
and consider $Q-\partial_r\phi$, both of which should converge
